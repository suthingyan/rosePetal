      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container bg-white text-dark mt-5">
           <div class="mt-4">
            ...
            <h1 class="text-center fw-bold mt-5 fs-2 mb-3">About Us Store List</h1>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{{ route('admin#aboutUsEdit',(int)$item->id) }}">
                            <button class="btn btn-sm btn-dark text-white">Edit</button>
                        </a>
                        <a href="{{ route('admin#aboutUsDelete',(int)$item->id) }}" onclick="return confirm('Are you sure delete?')">

      ...
      <div class="container-fluid page-body-wrapper bg-white">
       ...
       <div class="container text-dark">
        <div class="mt-5 fs-4 fw-bold mx-5">
          <a href="{{ route('admin#storeSlider') }}" style="text-decoration: none;color:black"><i class="mdi mdi-keyboard-backspace"> Back</i></a>
        </div>
        <h1 class="text-dark pt-5 fs-2 text-center fw-bold">About Us Edit</h1>
        
        <form action="{{ route('admin#sliderUpdate',$editData->id) }}" method="post" enctype="multipart/form-data" >
          @csrf
         
            <div class="row px-5 mt-5">
                <label for="image" class= "col-sm-2 col-form-label">Image</label>
                  <div class="col-sm-10">
                    {{-- <textarea name="" id="" class="form-control  text-white @error('image') is-invalid @enderror" cols="30" rows="30" style="background-color:grey">{{ old('image',$editData->image) }}</textarea> --}}

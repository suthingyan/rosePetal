    ...
    <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
      ...
      <ul class="navbar-nav navbar-nav-right">
        {{-- <li class="nav-item dropdown d-none d-lg-block">
          <a class="nav-link btn create-new-button" id="createbuttonDropdown" style="background-color:grey" data-bs-toggle="dropdown" aria-expanded="false" href="#">+ Create New Project</a>
